...
class KeyTest < Minitest::Test
  ...
  def test_can_accept_given_key
    e1 = Enigma.new
    e2 = Enigma.new
    e1.encrypt("This works!..end..", "12345", Date.today)
    e2.encrypt("And this is also now encrypted!..end..", "54321", Date.today)
  ...
  def test_generates_five_digit_key
    e1 = Enigma.new
    e2 = Enigma.new
    e1.encrypt("This works!..end..")
    e2.encrypt("And this is also now encrypted!..end..")
